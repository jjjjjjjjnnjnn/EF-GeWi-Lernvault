...
import { GLOBAL_SHORTCUTS, CARD_SHORTCUTS, QUIZ_SHORTCUTS, LIBRARY_SHORTCUTS, REISE_SHORTCUTS, ONBOARDING_SHORTCUTS, type Shortcut } from "../keys";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1C1B17]/20" onClick={onClose}>
      ...
      >
        ...
        <h3 className="mb-1 mt-4 font-mono text-[11px] uppercase tracking-wider text-[#6B675C]">Start / 引导</h3>
