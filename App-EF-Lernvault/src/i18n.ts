...
export const t = (lang: Lang) => ({
  ...
  navZoneOverview: lang === "de" ? "Übersicht & Plan" : "概览与规划",
  navZoneKnowledge: lang === "de" ? "Wissen & Struktur" : "知识与图谱",
  navZoneTraining: lang === "de" ? "Training & Praxis" : "训练与教具",
  navZoneSystem: lang === "de" ? "Assistenz & System" : "辅助与系统",
  ...
  helpTitleZh: "快捷键",
  closeHelp: "Tastaturhilfe schließen / 关闭快捷键帮助",
  languageSwitchLabel: "Sprache: Deutsch als Prüfungssprache, 中文 zum Verstehen / 语言：德语考试，中文理解",
  languageGermanLabel: "Deutsch als Prüfungssprache / 德语考试语言",
  languageChineseLabel: "中文 zum Verstehen / 中文理解语言",
  dailyTitle: "Heute lernen (15-Min-Sprint)",
  dailyTitleZh: "今日极速冲刺（15分钟）",
  dailyPartCards: "Teil 1/3: Wortschatz / 第1步：词汇",
  dailyPartQuiz: "Teil 2/3: Diagnose-Frage / 第2步：诊断题",
  dailyPartCompare: "Teil 3/3: Konzept-Vergleich / 第3步：概念对比",
  dailyComplete: "Sprint abgeschlossen / 冲刺完成",
  dailyRemaining: "Restzeit / 剩余时间",
  dailyClose: "Sprint schließen / 关闭冲刺",
  dailyShowAnswer: "Antwort zeigen (Leertaste)",
  dailyShowAnswerZh: "显示答案（空格键）",
  dailyAgain: "Nochmal (1)",
  dailyAgainZh: "重来（1）",
  dailyHard: "Schwer (2)",
  dailyHardZh: "困难（2）",
  dailyGood: "Gut (3)",
  ...
  dailyEasyZh: "简单（4）",
  dailyTopic: "Thema / 主题",
  dailyAnswerLabel: "Antwort in deutscher Fachsprache / 用德语专业语言作答",
  dailyAnswerPlaceholder: "Stichpunkte oder Formulierung in deutscher Fachsprache eingeben… / 用德语专业语言写要点或完整句…",
  dailyContinue: "Weiter zum Konzept-Vergleich",
  dailyContinueZh: "继续概念对比",
  dailyVersus: "vs. / 对比",
  dailyCompareLabel: "Vergleich / 概念对比",
  dailyComparePlaceholder: "Gemeinsamkeiten und zentrale Unterschiede kurz gegenüberstellen… / 简要比较共同点与核心差异…",
  dailyFinish: "Sprint abschließen & Streak sichern",
  dailyFinishZh: "完成冲刺并记录连续学习",
  dailySuccess: "Tages-Sprint erfolgreich gemeistert",
  dailySuccessZh: "今日冲刺已完成",
  dailyStreak: "Lernserie in Tagen / 连续学习天数",
  dailyStreakZh: "天",
  dailySummary: "Heute wurden Wortschatz und zwei zentrale Aufgaben wiederholt; die Wissensbeherrschung wurde aktualisiert.",
  dailySummaryZh: "今天复习了词汇并完成两项核心任务，掌握度已更新。",
  dailyBack: "Zurück zur Übersicht",
  dailyBackZh: "返回总览",
  masteryTitle: "Kompetenz-Radar (NRW Lehrplan)",
  masteryTitleZh: "能力雷达（北威州考纲）",
  masteryPercent: (value: number) => (lang === "de" ? `${value}% Beherrschung` : `掌握度 ${value}%`),
  termModeOn: "Semester-Modus: AN",
  termModeOnZh: "学期模式：开",
  termModeOff: "Semester-Modus: AUS",
  termModeOffZh: "学期模式：关",
  termArchive: "Archivieren",
  termArchiveZh: "归档",
  termReset: "Reset",
  termResetZh: "重置",
  termArchiveTitle: "Aktuellen Stand archivieren",
  termArchiveTitleZh: "归档当前进度",
  termResetTitle: "Diesen Semesterstand zurücksetzen",
  termResetTitleZh: "重置本学期进度",
  termArchiveDone: (term: string, time: string) =>
    lang === "de" ? `Semesterstand archiviert (${term}, ${time})` : `已归档学期进度（${term}，${time}）`,
  termResetConfirm: (term: string) =>
    lang === "de" ? `Möchten Sie die Daten für ${term} wirklich zurücksetzen?` : `确定重置 ${term} 的数据吗？`,
  masteryMastered: "Gefestigt",
  masteryMasteredZh: "已巩固",
  masteryProgress: "Im Aufbau",
  masteryProgressZh: "建构中",
