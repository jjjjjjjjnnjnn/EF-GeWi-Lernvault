# Philosophie Ressourcen (只放链接)

- Lehrplannavigator NRW Philosophie Sek II: https://lehrplannavigator.nrw.de/ (站内搜 Philosophie)
- 本地：`_Downloads/Philosophie/klp_gost_philosophie.pdf`（KLP全文，Amtliches Werk）

## 官方考试文件（Standardsicherung，本地 `_Downloads/Philosophie/`）

- Operatorenübersicht（2015）：https://www.standardsicherung.schulministerium.nrw.de/zentralabitur-gost/faecher/philosophie-gost
- Konstruktionsvorgaben + Korrekturzeichen：同上页
